...
void raster_scan(void){
  int i, j;
  int flag=0; //画素が見つからなかった場合の判断
  int attention[width][heigth]={};
  /*  int first_attention_i=0, first_attention_j=0;
  int attention_i=0, attention_j=0;
  int undo_point_i=0, undo_point_j=0;*/
